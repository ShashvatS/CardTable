...
import { handle_open, handle_close, handle_state_change } from "./datachannel";
...
export class RTCConnection {
    ...
    setupDataChannel() {
        ...
        this.peerConnection.onconnectionstatechange = handle_state_change(this.peerConnection, this.isHost);
    }
